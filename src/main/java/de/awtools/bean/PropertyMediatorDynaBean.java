/*
 * $Id: PropertyMediatorDynaBean.java 2297 2010-07-23 07:11:30Z andrewinkler $
 * ============================================================================
 ...
 */
public class PropertyMediatorDynaBean extends BasicDynaBean implements
    ...
    /**
     * @param _dynaClass Eine Beschreibung des <code>DynaBean</code>.
     */
     ...
     * @param index Der Index der Eigenschaft.
    ...
    public final void set(final String name, final int index, final Object value) {
        ...
        eventSupport.fireIndexedPropertyChange(name, new Integer(index),
            oldValue, value);
    }
